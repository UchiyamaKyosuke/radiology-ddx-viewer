...
try {
  ...
  nodeScript("Export mobile .zip pack", "export-mobile-pack.js");
  nodeScript("Validate mobile .zip pack", "validate-mobile-pack.js", [
    path.join("exports", "mobile", "radiology-ddx-pack.zip")
  ]);
